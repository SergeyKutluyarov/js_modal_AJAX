...
class Options {
    ...
    addDiv() {
        ...
        divAdd.classList.add("divnew");
        divAdd.textContent = "Новый текст"; 
        document.body.appendChild(divAdd);
        let divnew = document.querySelector('.divnew');
        divnew.style.cssText = `color: ${this.bg}; font-size:${this.fontSize}; text-align: ${this.textAlign}; `;
    }
}
let opt = new Options(0,0,'red','80px','center');
opt.addDiv();
